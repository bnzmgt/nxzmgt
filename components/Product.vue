            ...
            <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
                ...
                <div v-for="p in products">
                    <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">                        
                        <NuxtImg :src=p.image class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"></NuxtImg>
                    ...
                    <div>
                        <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">{{ p.title }}</a>            
                        <div class="flex items-end gap-2">
                            <span class="font-bold text-gray-800 lg:text-lg">${{ p.price }}</span>
